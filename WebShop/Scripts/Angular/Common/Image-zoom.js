  ...
  .directive('zoom', function () {
      function link(scope, element, attrs) {
          ...
          function moveMark(offsetX, offsetY) {
              var height = $(element).find('img').height() - scope.markHeight;
              var width = $(element).find('img').width() - scope.markWidth;
          ...
          function calculateOffset(mouseEvent) {
              ...
              if (mouseEvent.target.nodeName === "IMG") {
